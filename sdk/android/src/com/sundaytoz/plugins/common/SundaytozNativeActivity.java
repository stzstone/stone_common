...
public class SundaytozNativeActivity extends UnityPlayerActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.v("STZCommon", "SundaytozNativeActivity::onCreate()->v2.0.2_0416_1");
		try {
			Bundle bundle = getPackageManager().getApplicationInfo(getPackageName(), PackageManager.GET_META_DATA).metaData;
			String STZ_SCHEMA = "stzschema";
			stzSchema = bundle.getString(STZ_SCHEMA);
			Log.v("STZCommon", "stzSchema : " + stzSchema);
		...
		SundaytozAndroid.instance.RegisterNetworkReceiver();
	...
	protected void onResume() {
		...
		if(intent.hasExtra("deeplink"))
		{
			...
			Log.v("STZCommon", "SundaytozNativeActivity::onResume()->deeplink:" + deeplink);
			StorageUtil.saveDeeplinkData(this.getApplicationContext(), deeplink);
		}
